...
Notification.requestPermission().then(function(permission) {
  ...
  <input type="button" name="Çª½Ã" onclick="getThisData();" value="Çª½ÃÅ×½ºÆ®">
<hr>
  <form name="theForm" method="post">
		<input type="text" name="ke1y" value="<%=serverKey%>">
		<input type="text" name="TITLE" value="Çª½Ã">
		<input type="text" name="BODY" value="¸Þ·Õ">
  </form>

<input type="button" name="Çª½Ã" onclick="goAction();" value="Çª½ÃÆûÀü¼Û">
 </body>
